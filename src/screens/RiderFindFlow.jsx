...
import { Icons, Avatar, StarRating, Tag, PlaceSuggestField, WheelScrollColumn, TimeHourMinuteBlock } from "../components/shared.jsx";
import { formatScheduleChipLabel, formatCnDateLabel, sameCalendarDay } from "../components/shared.jsx";
import { shortSchedulePlaceName } from "../utils/scheduleUtils.js";

export default function RiderFindFlow() {
  const ctx = useAppCtx();
  const {
    tab, role, t, colors, styles, themePrimary, themePrimaryRgb, lang,
    currentLocationCoords, activeCampus,
    riderStep, setRiderStep,
    riderFrom, handleRiderFromChange, riderFromCoords, setRiderFromCoords,
    riderTo, handleRiderToChange, riderToCoords, setRiderToCoords,
    fromUseCurrentLocation, setFromUseCurrentLocation,
    currentLocationLabel,
    snapOriginToCurrentLocation,
    commonRoutes, setRiderFrom,
    ...
    riderPostError, setRiderPostError,
    riderPosting, commitRiderPost,
  } = ctx;

  if (tab !== "find" || role !== "rider") return null;
        ...
        <div style={{ ...styles.card, marginTop: 2, padding: "20px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 18 }}>
            ...
            <div style={{
              ...
              {fromUseCurrentLocation ? currentLocationLabel : riderFrom || t("label_origin_fallback")}
            </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 18 }}>
            ...
            <div style={{ flex: 1, display: "flex", alignItems: "center", gap: 4, fontSize: 12, fontWeight: 600, color: colors.navy, overflow: "hidden", minWidth: 0 }}>
              <span style={{ overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                {fromUseCurrentLocation ? currentLocationLabel : riderFrom}
              </span>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "stretch", gap: 12 }}>
              ...
              <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 10 }}>
                ...
                <div style={{ fontSize: 14, fontWeight: 600, color: colors.text }}>{riderTo}</div>
              </div>
            </div>
